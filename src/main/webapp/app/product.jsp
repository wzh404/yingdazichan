...
<div class="i-assets-data">
    <dl class="Wide">
        <dt>总额度</dt>
        <dd>
            <em><label id="labMJGuiMo">${totalAmount}</label></em><span class="fw-normal"><label id="labUnit">元</label></span>
        </dd>
    </dl>
    <dl class="Deadline">
        <dt>投资期限</dt>
    ...
    <dl class="border-none Yield">
        ...
        <dd><em><label id="labShouYiLv" style="color:#1172bd">11.0</label></em>%</dd>
    </dl>
</div>
<div class="d-main">
    <ul class="d-con">
