...
<div class="i-assets-data">
    <dl class="Wide">
        <dt>投资金额</dt>
        <dd>
            <em><label id="labMJGuiMo" style="color:#1172bd">${investment.investAmount}</label></em>
            <span class="fw-normal"><label id="labUnit">元</label></span>
        </dd>
    </dl>
    <dl class="Deadline">
        <dt>投资期限</dt>
        <dd><em><label id="labQiXian">${product.getInvestDayValue()}</label></em><span class="fw-normal">
            <label id="labQiXianDesc">${product.getInvestDayUnitName()}</label></span>
        </dd>
    </dl>
    <dl class="border-none Yield">
        <dt class="iocn-help-pr">年化收益率</dt>
        <dd><em><label id="labShouYiLv" style="color:#FF0033">${investment.investRate}</label></em>%</dd>
    </dl>
</div>
<div class="d-main">
    <ul class="d-con">
        <li><span class="d-con-t">预期收益</span><label id="labQiXiRi1">${investment.investIncome}元</label></li>
        <li><span class="d-con-t">状态</span><label id="labQiXiRi2">还款中</label></li>
        <li><span class="d-con-t">手续费</span><label id="labQiXiRi5">0.00元</label></li>
        <li><span class="d-con-t">起息日</span><label id="labQiXiRi3"><fmt:formatDate value="${investment.investStartDate}" pattern="yyyy-MM-dd"/></label></li>
        <li><span class="d-con-t">结息日</span><label id="labJieXiRi"><fmt:formatDate value="${investment.investClosingDate}" pattern="yyyy-MM-dd"/></label></li>
