 ...
 * 身份证校验
 *
 * Created by wangzunhui on 2015/10/19.
 */
public class IDCard {
    ...
    public boolean verify(String idcard) {
        ...
        //性别
        Integer c17 = Integer.parseInt(idcard.substring(16, 17));
        if ((c17 % 2) == 0) {
            sex = "F";
        } else {
            sex = "M";
    ...
    //获得校验位
    private String getVerify(String code) {
        int remaining = 0;
